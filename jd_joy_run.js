...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['jd_5ce1734f244a4,15051002576_p,jd_cdYuVWalQTzR'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['jd_5ce1734f244a4,15051002576_p,jd_cdYuVWalQTzR'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ['jd_5ce1734f244a4,15051002576_p,jd_cdYuVWalQTzR'];
...
function getFriendPins() {
  return new Promise(resolve => {
    $.get({
      url: "https://github.com/chuan0205/updateTeam/blob/master/friendPins.json",
      headers:{
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      },
