...
//   $.shareCodes = [];
  var codes = [
				"EEDAEC0DC94A51FC3435722C266810C2AA668B508B17E024E97ACA14B5F34D90",
				"C143544043A51A2F647ACA712012EAA499E2207C090477C17441FE0C5EB2E6A4",
				"848417716A74006888B69D41FC572A666536D2FB59835572B9B195A4AE575DDB",
				"7563F57AB240F7E58ADB4ED71872B0988D3C52DC7DA0EC347C882A4C2AE092C8",
				"C3CD23F99D988685E0A5254864572E7B3007CEC9E89B9A5428F526179DB529CC",
				"46E276252CCF367812352F9D34535B03A9DE76D94410B19BB33F491695CB4703",
				"4B7DF6D17B1AC7F3F7DB89F153CAB64635FA08284B1E83A435F2B833C93DDB40",
			];
//   $.shareCodes.push(...codes)
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    ...
    if ($.shareCodes && $.shareCodes.length) {
      console.log(`\n自己账号内部循环互助\n`);
      console.log(`\n助力前${helpNum}个账号\n`);
      for (let j = 0; j < helpNum && $.canHelp; j++) {
