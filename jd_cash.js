...
[task_local]
#签到领现金
2 1,14 * * * jd_cash.js, tag=签到领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "2 1,14 * * *" script-path=jd_cash.js,tag=签到领现金

===============Surge=================
签到领现金 = type=cron,cronexp="2 1,14 * * *",wake-system=1,timeout=3600,script-path=jd_cash.js

============小火箭=========
签到领现金 = type=cron,script-path=jd_cash.js, cronexpr="2 1,14 * * *", timeout=3600, enable=true
 */
const $ = new Env('签到领现金');
...
const inviteCodes = [
  `eU9Yab_nZ_sl9TjXz3dC0g@Ih43ae2yZv4j9mi6iw@eU9YP7jbI5pBoDK0rzlx@eU9YGb_TFatvlhC3oyx7@eU9YO7vXGLpSkBCUkjpU@eU9YLZrlD45XihqBtgVC@eU9YC5fQBadYgA-EsBRr@eU9YBqrbAblFizWOjzJL`,
  `eU9Yab_nZ_sl9TjXz3dC0g@Ih43ae2yZv4j9mi6iw@eU9YP7jbI5pBoDK0rzlx@eU9YGb_TFatvlhC3oyx7@eU9YO7vXGLpSkBCUkjpU@eU9YLZrlD45XihqBtgVC@eU9YC5fQBadYgA-EsBRr@eU9YBqrbAblFizWOjzJL`,
]
if ($.isNode()) {
