...
[task_local]
#东东超市
11 6,18 * * * jd_superMarket.js, tag=东东超市, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true
===========Loon===============
[Script]
...
async function barGain() {
  let res = await getAuthorShareCode2('https://raw.githubusercontent.com/chuan0205/updateTeam/master/shareCodes/jd_barGain.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/chuan0205/updateTeam@master/shareCodes/jd_barGain.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/chuan0205/updateTeam@master/shareCodes/jd_barGain.json')
  }
